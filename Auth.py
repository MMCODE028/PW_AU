...
def AuthToken():
    ...
    payload='grant_type=client_credentials&client_id=9NJrPg9FsFbAqTBfKvJernAZYw7cpdtm&client_secret=VMjsx1blAXX3W2Kq&scope=data%3Aread%20data%3Awrite%20data%3Acreate%20bucket%3Aread%20bucket%3Acreate'
    headers = {
